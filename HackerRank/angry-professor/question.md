...
A Discrete Mathematics professor has a class of students. Frustrated with their lack of discipline, the professor decides to cancel class if fewer than some number of students are present when class starts.  Arrival times go from on time (
...
The first 
 ...
 students arrived on.  The last 

 were late.  The threshold is 
...
, the number of students (size of 
...
. The professor wants at least 

 students in attendance, but only 
...
. The professor wants at least 
 ...
 students in attendance, and there are 
