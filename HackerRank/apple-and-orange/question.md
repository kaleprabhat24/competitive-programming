...
- When a fruit falls from its tree, it lands 
 ...
 units of distance from its tree of origin along the 

-axis. *A negative value of 

 means the fruit fell 
...
Given the value of 
 ...
 oranges, determine how many apples and oranges will fall on Sam's house (i.e., in the inclusive range 
...
The fourth line contains 
 ...
 space-separated integers denoting the respective distances that each apple falls from point 

. 

The fifth line contains 

 space-separated integers denoting the respective distances that each orange falls from point 
...
Only one fruit (the second apple) falls within the region between 
...
Only the second orange falls within the region between 
