...
, that may not be of the same length, determine the minimum number of character deletions required to make 
...
The only characters that match are the 

's so we have to remove 
...
- It is guaranteed that 
 ...
 consist of lowercase English letters, ascii[a-z].
