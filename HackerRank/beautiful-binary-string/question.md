...
In one step, Alice can change a 
 ...
 or vice versa. Count and print the minimum number of steps needed to make Alice see the string as beautiful.
...
Make the string beautiful by changing 
...
, so the string is already beautiful in 
...
One solution is to change the values of 
