...
, there are two segment widths of 

 and 

 respectively.  The widest vehicle that can fit through both is 
...
, where 
 ...
 denotes the number of width measurements and 

, the number of test cases. The next line has 
