...
The first values are the return date and the second are the due date.  The years are the same and the months are the same.  The book is 
...
, and 
 ...
 on which the book was returned. 
...
, we know it is less than a year late. 

Because 

, we know it's less than a month late. 
