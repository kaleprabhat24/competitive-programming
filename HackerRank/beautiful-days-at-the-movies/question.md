...
, determine the number of days in the range that are *beautiful*.  Beautiful numbers are defined as numbers where 
...
, in this interval are beautiful. Thus, we print 
