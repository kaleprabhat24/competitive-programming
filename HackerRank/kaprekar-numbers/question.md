...
Consider a positive whole number 
 ...
 to arrive at a number that is either 

 digits long or 

 digits long.  Split the string representation of the square into two parts, 
...
.  The right hand part, 
 ...
 digits long.  The left is the remaining substring.  Convert those two substrings back to integers, add them and see if you get 
...
. Split that into two strings and convert them back to integers 

 and 

.  Test 

, so this is not a modified Kaprekar number.  If 
...
, write a program to print the modified Kaprekar numbers in the range between 
...
, and 
 ...
 are the modified Kaprekar Numbers in the given range.
