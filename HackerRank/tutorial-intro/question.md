...
), can you print the index location of 
...
The last line contains 
 ...
 space-separated integers, each a value of 
...
. The value 
 ...
 element in the array.  Its index is 

 since the array indices start from 

 (see array definition under *Input Format*).
