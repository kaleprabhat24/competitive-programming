...
, of lowercase English letters that is repeated infinitely many times.  Given an integer, 
...
, the first 
 ...
 characters of the infinite string.  There are 
...
The first 
 ...
 letters of the infinite string are `abaabaabaa`. Because there are 
